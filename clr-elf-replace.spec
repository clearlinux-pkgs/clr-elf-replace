...
Version  : 3
Release  : 3
URL      : http://localhost/cgit/projects/clr-elf-replace/snapshot/clr-elf-replace-3.tar.xz
Source0  : http://localhost/cgit/projects/clr-elf-replace/snapshot/clr-elf-replace-3.tar.xz
...
%prep
%setup -q -n clr-elf-replace-3
cd %{_builddir}/clr-elf-replace-3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633976854
...
cp %{_builddir}/clr-elf-replace-3/LICENSE %{buildroot}/usr/share/package-licenses/clr-elf-replace/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
