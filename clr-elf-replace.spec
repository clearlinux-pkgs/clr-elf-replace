...
Version  : 2
Release  : 2
URL      : http://localhost/cgit/projects/clr-elf-replace/snapshot/clr-elf-replace-2.tar.xz
Source0  : http://localhost/cgit/projects/clr-elf-replace/snapshot/clr-elf-replace-2.tar.xz
...
%prep
%setup -q -n clr-elf-replace-2
cd %{_builddir}/clr-elf-replace-2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633969972
...
cp %{_builddir}/clr-elf-replace-2/LICENSE %{buildroot}/usr/share/package-licenses/clr-elf-replace/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
